...
import { FireBaseIntegrator } from "./libs/firebase";
...
export class Scraper {
    ...
    constructor() {
        ...
        this.configs = (new ConfigReader()).parseSync(__dirname + "/queue/wynnlasvegas.json") as QueueConfig;
    ...
    onEmptyQueue(): void {
        ...
        (new FireBaseIntegrator((new ConfigReader()).parseSync(this.cacheDir + "/result.json"))).saveToFirebase().then((r) => {
